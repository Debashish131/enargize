                        ...
                        <form method="post" action="/" id="custom-form-wizard">
                            <div class="wizard steps-bg steps-left">
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Account Number </h6></label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            ...
                                            @else
                                                <input type="text" placeholder="Account" name="pan_number"
                                ...
                                <section class="wizard-section">
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Account Code </h6></label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            ...
                                            @else
                                                <input type="text" placeholder="account code..." name="ifsc_code"
                                    ...
                                    <div class="section">
                                        <label for="input002"><h6 class="mb20 mt40"> Nomenee Account Number </h6></label>
                                        <label for="input002" class="field prepend-icon">
                                            @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                            ...
                                            @else
                                                <input type="text" placeholder="Nomenee account number..."
                                   ...
                                   <div class="section">
                                       <label for="input002"><h6 class="mb20 mt40"> Phone Number</h6></label>
                                       <label for="input002" class="field prepend-icon">
                                           @if(\Route::getFacadeRoot()->current()->uri() == 'edit-emp/{id}')
                                           ...
                                           @else
                                             <input type="text" placeholder="Phone Number" name="un_number" id="un_number" class="gui-input">
                                              <label for="input002" class="field-icon">
                                                  <i class="fa fa-list"></i>
                                              </label>
                                           @endif
